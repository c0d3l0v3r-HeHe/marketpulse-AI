      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.99 }}
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-white/[0.08] bg-white/[0.03] text-zinc-300 text-sm font-medium transition-colors"
          >
